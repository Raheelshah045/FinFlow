    ...
    return (
        <div style={{ animation: "fadeUp 0.4s cubic-bezier(0.16, 1, 0.3, 1)" }}>
            ...
            <div className="voucher-top-bar" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 32, flexWrap: "wrap", gap: 16 }}>
                ...
                <button onClick={() => setShowForm(true)} style={{ display: "flex", alignItems: "center", gap: 10, background: "var(--primary)", color: "#fff", border: "none", borderRadius: "12px", padding: "12px 24px", fontWeight: 700, fontSize: 14, cursor: "pointer", transition: "all 0.3s", boxShadow: "0 10px 15px -3px rgba(37, 99, 235, 0.2)" }} onMouseEnter={e => { e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 20px 25px -5px rgba(37, 99, 235, 0.3)"; }} onMouseLeave={e => { e.currentTarget.style.transform = "none"; e.currentTarget.style.boxShadow = "0 10px 15px -3px rgba(37, 99, 235, 0.2)"; }}>
